...
const probeDir = new URL("./node_modules", import.meta.url).pathname.replace(/^\//, "");

// Pass through all args except the script name itself, append probe locations
const args = [
  "--stdio",
  ...argv.slice(2),
  "--ngProbeLocations", probeDir,
  "--tsProbeLocations", probeDir,
  "--logToConsole",
  "--logFile", new URL("./ngserver.log", import.meta.url).pathname.replace(/^\//, ""),
  "--logVerbosity", "verbose",
];
const ngserverPath = new URL("./node_modules/@angular/language-server/index.js", import.meta.url).pathname.replace(/^\//, "");
const child = spawn(process.execPath, [ngserverPath, ...args], {
